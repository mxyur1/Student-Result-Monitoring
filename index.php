...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="index.php">MIT ACSC- (Automated Student Result Monitoring)</a>
        ...
        <header class="py-5 bg-image-full" style="background-image: url('images/1.jpg')">
...
<?php }} ?>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Automated Student Result Monitoring <?php echo date('Y');?></p></div>
        </footer>
        <!-- Bootstrap core JS-->
